...
My current work focuses on the design, growth, and characterization of nitride and oxide semiconductors. I’ve worked with materials such as AlGaN, AlScN, AlYN, AlBN, and α-(Al,Ga)<sub>2</sub>O<sub>3</sub>. A good portion of my time is spent in the cleanroom and photonics lab, and occasionally on the MOCVD reactor (and sometimes the MBE system).
